...
export const TXN_LIST_COLUMNS =
  "id, source, external_key, txn_date, amount, kind, currency, description, merchant, status, category, purpose_note, expense_type, is_internal, needs_categorization, created_at, updated_at";
